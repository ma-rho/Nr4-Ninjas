...
export default function DjProfilePage({ params }: { params: { slug: string } }) {
  ...
  const galleryImages = dj.gallery.map((id) =>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
          ...
          <div className="mt-6 flex justify-center space-x-2">
            {dj.socials.instagram && (
              <Button asChild variant="ghost" size="icon">
                <Link href={dj.socials.instagram} target="_blank">
                  <Instagram />
            ...
            {dj.socials.tiktok && (
              <Button asChild variant="ghost" size="icon">
                <Link href={dj.socials.tiktok} target="_blank">
            ...
            {dj.socials.soundcloud && (
              <Button asChild variant="ghost" size="icon">
                <Link href={dj.socials.soundcloud} target="_blank">
                  <Music />
      ...
      <div>
        <h2 className="text-center font-headline text-4xl uppercase">Gallery</h2>
        ...
        <Card className="mt-8 bg-secondary">
          <CardContent className="flex h-48 items-center justify-center p-6">
            <div className="text-center text-muted-foreground">
              ...
              <p className="mt-4">Embedded mix coming soon.</p>
            </div>
          </CardContent>
        </Card>
      </div>
